			...
			<c:forEach var="w" items="${allmenu }">
				<c:if test="${q.id==w.pid}">
						 ...
						 <tr>
						  ...
						  <c:forEach var="n" items="${list }">
						  		<c:if test="${fn:split(n.menu_id, '.')[0] == w.id}">
									<c:if test="${fn:containsIgnoreCase(n.menu_id, 'add')}"><c:set var="_add" value="1" /> </c:if>
									<c:if test="${fn:containsIgnoreCase(n.menu_id, 'delete')}"><c:set var="_delete" value="1" /> </c:if>
									<c:if test="${fn:containsIgnoreCase(n.menu_id, 'view')}"><c:set var="_view" value="1" /> </c:if>
									<c:if test="${fn:containsIgnoreCase(n.menu_id, 'update')}"><c:set var="_update" value="1" /> </c:if>
									<c:if test="${fn:containsIgnoreCase(n.menu_id, 'import')}"><c:set var="_import" value="1" /> </c:if>
									<c:if test="${fn:containsIgnoreCase(n.menu_id, 'export')}"><c:set var="_export" value="1" /> </c:if>
								</c:if>
							</c:forEach>
						  ...
						  <tr>
							<td>
								...
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								<input class="pc" type="checkbox" id="${q.id}" name="menu_id" value="${w.id }.Delete" 
						 			<c:if test="${_delete == '1'}">
						 				checked = 'true'
						 			</c:if>
						  			/>
								...
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								<input class="pc" type="checkbox" id="${q.id}" name="menu_id" value="${w.id }.Update" 
						 			<c:if test="${_update == '1'}">
						 				checked = 'true'
						 			</c:if>
						  			/>
						...
						<tr>
							<td>
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								<input class="pc" type="checkbox" id="${q.id}" name="menu_id" value="${w.id }.Import" 
						 			<c:if test="${_import == '1'}">
						 				checked = 'true'
						 			</c:if>
						  			/>
								...
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								<input class="pc" type="checkbox" id="${q.id}" name="menu_id" value="${w.id }.Export" 
						 			<c:if test="${_export == '1'}">
						 				checked = 'true'
						 			</c:if>
						  			/>
