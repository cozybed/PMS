...
var handleBasicChart = function () {
    ...
    if ($("#basic-chart").length !== 0) {
        $.plot($("#basic-chart"), [{label: "data 1", data: e, color: purple, shadowSize: 0}, {
            label: "data 2",
            data: n,
            color: green,
            shadowSize: 0
...
var handleStackedChart = function () {
    ...
    var h = [[0, "Monday"], [1, "Tuesday"], [2, "Wednesday"], [3, "Thursday"], [4, "Friday"], [5, "Saturday"]];
    var p = {
        xaxis: {tickColor: "transparent", ticks: h},
        ...
        series: {
            ...
            bars: {show: true, barWidth: .5, align: "center", fillColor: null},
            highlightColor: "rgba(0,0,0,0.8)"
        },
        legend: {show: true, labelBoxBorderColor: "#ccc", position: "ne", noColumns: 1}
    };
    var d = [{data: e, color: purpleDark, label: "China", bars: {fillColor: purpleDark}}, {
        data: n,
        color: purple,
        label: "Russia",
        bars: {fillColor: purple}
    }, {data: i, color: purpleLight, label: "Canada", bars: {fillColor: purpleLight}}, {
        data: o,
        color: blueDark,
        label: "Japan",
        bars: {fillColor: blueDark}
    }, {data: a, color: blue, label: "USA", bars: {fillColor: blue}}, {
        data: l,
        color: blueLight,
        label: "Others",
...
var handleTrackingChart = function () {
    ...
    if ($("#tracking-chart").length !== 0) {
        var i = $.plot($("#tracking-chart"), [{data: e, label: "Series1", color: dark, shadowSize: 0}, {
            data: t,
            label: "Series2",
            color: red,
            shadowSize: 0
            ...
            xaxis: {tickLength: 0},
            yaxis: {tickColor: "#ddd"},
            legend: {labelBoxBorderColor: "#ddd", backgroundOpacity: .4, color: "#fff", show: true}
        });
...
var handleBarChart = function () {
    ...
    if ($("#bar-chart").length !== 0) {
        ...
        $.plot("#bar-chart", [{data: e, color: purple}], {
            series: {
                bars: {
                    show: true,
                    barWidth: .4,
...
var handleInteractivePieChart = function () {
    ...
    if ($("#interactive-pie-chart").length !== 0) {
        ...
        for (var r = 0; r < t; r++) {
            e[r] = {label: "Series" + (r + 1), data: Math.floor(Math.random() * 100) + 1, color: n[r]}
        }
...
var handleDonutChart = function () {
    ...
    if ($("#donut-chart").length !== 0) {
        ...
        for (var s = 0; s < t; s++) {
            e[s] = {label: r[s], data: i[s], color: n[s]}
        }
        $.plot($("#donut-chart"), e, {
            series: {
                pie: {
...
var handleInteractiveChart = function () {
    ...
    if ($("#interactive-chart").length !== 0) {
        var t = [[0, 42], [1, 53], [2, 66], [3, 60], [4, 68], [5, 66], [6, 71], [7, 75], [8, 69], [9, 70], [10, 68], [11, 72], [12, 78], [13, 86]];
        var n = [[0, 12], [1, 26], [2, 13], [3, 18], [4, 35], [5, 23], [6, 18], [7, 35], [8, 24], [9, 14], [10, 14], [11, 29], [12, 30], [13, 43]];
...
var handleLiveUpdatedChart = function () {
    ...
    if ($("#live-updated-chart").length !== 0) {
        ...
        var s = {
            series: {shadowSize: 0, color: purple, lines: {show: true, fill: true}},
