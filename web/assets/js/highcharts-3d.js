...
(function (d) {
    ...
    d.SVGRenderer.prototype.arc3d = function (c) {
        ...
        a.animate = function (a, b, c) {
            o(a.end) || o(a.start) ? (this._shapeArgs = this.shapeArgs, d.SVGElement.prototype.animate.call(this,
                    {_args: a}, {
                        duration: b, start: function () {
                            var a = arguments[0].elem, b = a._shapeArgs;
    ...
    d.SVGRenderer.prototype.arc3dPath = function (c) {
        ...
        i *= m(h);
        var w = j * l(k), o = j * l(h), j = ["M", a + s * v, b + t * p], j = j.concat(r(a, b, s, t, e, d, 0, 0)), j = j.concat(["L", a + u * c, b + i * n]), j = j.concat(r(a, b, u, i, d, e, 0, 0)), j = j.concat(["Z"]), k = k > 0 ? q / 2 : 0, h = h > 0 ? 0 : q / 2, k = e > -k ? e : d > -k ? -k : e, x = d < q - h ? d : e < q - h ? q - h : d, h = ["M", a + s * m(k), b + t * l(k)], h = h.concat(r(a,
            b, s, t, k, x, 0, 0)), h = h.concat(["L", a + s * m(x) + w, b + t * l(x) + o]), h = h.concat(r(a, b, s, t, x, k, w, o)), h = h.concat(["Z"]), k = ["M", a + u * v, b + i * p], k = k.concat(r(a, b, u, i, e, d, 0, 0)), k = k.concat(["L", a + u * m(d) + w, b + i * l(d) + o]), k = k.concat(r(a, b, u, i, d, e, w, o)), k = k.concat(["Z"]), v = ["M", a + s * v, b + t * p, "L", a + s * v + w, b + t * p + o, "L", a + u * v + w, b + i * p + o, "L", a + u * v, b + i * p, "Z"], a = ["M", a + s * c, b + t * n, "L", a + s * c + w, b + t * n + o, "L", a + u * c + w, b + i * n + o, "L", a + u * c, b + i * n, "Z"], b = l((e + d) / 2), e = l(e), d = l(d);
        return {
    ...
    d.wrap(d.Axis.prototype, "setOptions", function (c, a) {
        var b;
        c.call(this, a);
        if (this.chart.is3d()) b = this.options, b.tickWidth = d.pick(b.tickWidth, 0), b.gridLineWidth = d.pick(b.gridLineWidth, 1)
    });
    d.wrap(d.Axis.prototype, "render", function (c) {
        ...
        if (this.chart.is3d()) {
            ...
            if (!this.isZAxis) this.horiz ? (i = {
                    x: l,
                    y: p + (a.xAxis[0].opposite ? -g.size : h),
                    z: 0,
                    width: k,
                    height: g.size,
                    depth: j,
                    ...
                    depth: i.size,
                    insidePlotArea: !1
                }, this.backFrame ? this.backFrame.animate(d) : this.backFrame =
                        b.cuboid(d).attr({
                            fill: i.color,
                            zIndex: -3
                        }).css({stroke: i.color}).add(), a = {
    ...
    d.wrap(d.Axis.prototype, "getPlotLinePath", function (c) {
        ...
        var b = this.chart.options.chart.options3d,
            b = this.isZAxis ? this.chart.plotWidth : b.depth, d = this.opposite;
        this.horiz && (d = !d);
    ...
    d.wrap(d.Axis.prototype, "getPlotBandPath", function (c) {
        if (this.chart.is3d()) {
            var a = arguments,
                b = a[1], a = this.getPlotLinePath(a[2]);
            (b = this.getPlotLinePath(b)) && a ? b.push("L", a[10], a[11], "L", a[7], a[8], "L", a[4], a[5], "L", a[1], a[2]) : b = null;
            return b
    ...
    d.wrap(d.Tick.prototype,
        "getLabelPosition", function (c) {
            var a = c.apply(this, [].slice.call(arguments, 1));
            if (!this.axis.chart.is3d())return a;
    ...
    d.wrap(d.seriesTypes.column.prototype, "animate", function (c) {
        if (this.chart.is3d()) {
            var a =
                arguments[1], b = this.yAxis, e = this, f = this.yAxis.reversed;
            if (d.svg) a ? d.each(e.data, function (a) {
    ...
    d.wrap(d.Series.prototype, "alignDataLabel", function (c) {
        if (this.chart.is3d() && (this.type === "column" || this.type === "columnrange")) {
            var a =
                arguments[4], b = {x: a.x, y: a.y, z: this.z}, b = n([b], this.chart, !0)[0];
            a.x = b.x;
            a.y = b.y
        }
        c.apply(this, [].slice.call(arguments, 1))
    ...
    d.wrap(d.seriesTypes.pie.prototype,
        "drawPoints", function (c) {
            var a = this.group, b = this.options, e = b.states;
    ...
    d.wrap(d.seriesTypes.pie.prototype,
        "animate", function (c) {
            if (this.chart.is3d()) {
                var a = arguments[1], b = this.options.animation, e = this.center, f = this.group, g = this.markerGroup;
                if (d.svg)if (b === !0 && (b = {}), a) {
    ...
    d.wrap(d.seriesTypes.scatter.prototype,
        "init", function (c, a, b) {
            if (a.is3d()) this.axisTypes = ["xAxis", "yAxis", "zAxis"], this.pointArrayMap = ["x", "y", "z"], this.parallelArrays = ["x", "y", "z"];
            c = c.apply(this, [a, b]);
    ...
    if (d.VMLRenderer) d.setOptions({animate: !1}), d.VMLRenderer.prototype.cuboid =
